...
public class MinMaxPriorityQueueTest {
    ...
    public void testEmptyQueue() {
        assertNull(strQueue.minPriorityItem());
        assertNull(strQueue.maxPriorityItem());
    }
    ...
    @Test
    public void testMinQueueDifferentItemWithSamePriorityFew() {
        strQueue.add("a", 10);
        strQueue.add("b", 12);
        strQueue.add("c", 1);
        strQueue.add("d", 1);
    ...
    public void testMinQueueMultiTimes1() {
        ...
        for (int i = 0; i < 10000; ++i) {
            assertEquals(Integer.valueOf(i), intQueue.minPriorityItem());
        }
        assertNull(intQueue.minPriorityItem());
    }
    ...
    public void testMinQueueMultiTimes2() {
        ...
        for (int i = 0; i < 10000; ++i) {
            assertEquals(Integer.valueOf(9999 - i), intQueue.minPriorityItem());
        }
        assertNull(intQueue.minPriorityItem());
    }
    ...
    public void testMaxQueueMultiTimes1() {
        ...
        for (int i = 0; i < 10000; ++i) {
            assertEquals(Integer.valueOf(9999 - i), intQueue.maxPriorityItem());
        }
        assertNull(intQueue.maxPriorityItem());
    }
    ...
    public void testMaxQueueMultiTimes2() {
        ...
        for (int i = 0; i < 10000; ++i) {
            assertEquals(Integer.valueOf(i), intQueue.maxPriorityItem());
        }
        assertNull(intQueue.maxPriorityItem());
    }
    ...
    public void testMinMaxQueueMultiTime1() {
        ...
        for (int i = 0; i < 50; ++i) {
            for (int j = 0; j < 100; ++j) {
                assertEquals(Integer.valueOf(i), intQueue.minPriorityItem());
                assertEquals(Integer.valueOf(99 - i), intQueue.maxPriorityItem());
            }
        }
    }
}